...
#python src/fills_info/getFills.py -suffix ${suffix} -ff ${first_fill} -lf ${last_fill}
#python src/luminosity/getIntegratedLuminosity.py -suffix ${suffix} -ff ${first_fill} -lf ${last_fill} -from oms

# This can be run for all fills, a small range of fills or just one
#python src/currents/getCurrentsFromDB.py -i data/fills_info/fills_${suffix}.csv -ff ${first_fill} -lf ${last_fill} -s ${sub_system}
#python src/currents/getCurrents.py -ff ${first_fill} -lf ${last_fill} -s ${sub_system}
